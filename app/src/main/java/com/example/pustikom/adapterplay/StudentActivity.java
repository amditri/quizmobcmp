...
import com.example.pustikom.adapterplay.com.example.pustikom.adapter.db.StudentDbHelper;
...
public class StudentActivity extends AppCompatActivity {
    ...
    private class DataSyncTask extends AsyncTask<List, Void, StudentArrayAdapter> {
        protected StudentArrayAdapter doInBackground(List... list) {
